...
const swiftSourcePath = path.join(__dirname, "get-selection.swift");
const distDir = path.join(__dirname, "../dist");
const binaryPath = path.join(distDir, "get-selection");

console.log("Building get-selection Swift binary...");
...
swiftc.on("close", (code) => {
  if (code === 0) {
    ...
    console.log(`Successfully compiled get-selection to ${binaryPath}`);
  } else {
