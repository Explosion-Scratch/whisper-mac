...
Napi::Object Init(Napi::Env env, Napi::Object exports) {
  ...
  exports.Set(Napi::String::New(env, "registerPushToTalkHotkey"), Napi::Function::New(env, RegisterPushToTalkHotkey));
  exports.Set(Napi::String::New(env, "unregisterPushToTalkHotkey"), Napi::Function::New(env, UnregisterPushToTalkHotkey));
  return exports;
}
